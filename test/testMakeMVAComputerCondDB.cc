...
class GenericMVAJetTagMakeDiscriminatorCondDB : public edm::EDAnalyzer {
    public:
	explicit GenericMVAJetTagMakeDiscriminatorCondDB(const edm::ParameterSet &params);
...
GenericMVAJetTagMakeDiscriminatorCondDB::GenericMVAJetTagMakeDiscriminatorCondDB(
					const edm::ParameterSet &params) :
	record(params.getUntrackedParameter<std::string>("record"))
{
}

void GenericMVAJetTagMakeDiscriminatorCondDB::analyze(const edm::Event& iEvent,
                                      const edm::EventSetup& iSetup)
{
}

void GenericMVAJetTagMakeDiscriminatorCondDB::endJob()
{
// set up some dummy calibration by hand for testing

	MVAComputerContainer *container = new MVAComputerContainer;
	MVAComputer *computer = &container->add("TestCalibration");
...
DEFINE_SEAL_MODULE();
DEFINE_ANOTHER_FWK_MODULE(GenericMVAJetTagMakeDiscriminatorCondDB);
